  ...
  return (
    <aside aria-label="WhatsApp Contact" className="fixed bottom-6 right-6 z-30 flex items-center group">
      ...
      <a
        ...
        className="flex items-center justify-center w-14 h-14 bg-[#25D366] hover:bg-[#20ba59] text-white rounded-full shadow-2xl transition-all duration-300 transform hover:scale-110 active:scale-95 focus:outline-none focus:ring-4 focus:ring-[#25D366]/40"
      >
        <svg
