...
const HEADING = "The people running the work";
const INTRO =
  "Permanent leadership rather than a rotating list of subcontractors. These are the people accountable for what happens on your site.";

/* Dummy data — replace names, roles, and photos with the real team. */
const MEMBERS: TeamMember[] = [
  {
    name: "Sheikh Ali Al Attaf",
    role: "Founder & Chairman",
    image: "/images/teamMembers/per-1.jpg",
  },
  {
    name: "Mohammed Al Attaf",
    role: "Managing Director",
    image: "/images/teamMembers/per-2.jpg",
  },
  {
    name: "Eng. Khalid Rahman",
    role: "Projects Manager",
    image: "/images/teamMembers/per-1.jpg",
  },
  {
    name: "Eng. Samir Haddad",
...
export default function TeamSection() {
  return (
    <section className="w-full bg-white font-sans py-20 lg:py-28">
