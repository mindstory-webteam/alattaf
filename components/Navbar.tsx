...
export default function Navbar() {
  ...
  return (
    <>
      <header
        className={`fixed top-0 left-0 right-0 z-40 transition-transform duration-300 ease-in-out font-sans ${
      ...
      >
        ...
        <nav
          className={`w-full bg-white transition-all duration-300 border-b border-slate-100 shadow-sm ${
            isScrolled ? "py-2 sm:py-2.5 shadow-md" : "py-2.5 sm:py-3"
          }`}
        >
              ...
              >
                <div className="relative flex items-center">
                  <Image
                    ...
                    width={220}
                    height={75}
                    className="h-12 sm:h-14 lg:h-[62px] w-auto object-contain transition-transform duration-300 group-hover:scale-105"
                    priority
                  />
                </div>
              </Link>
        ...
        >
          ...
          <div className="flex items-center justify-between px-5 pt-8 pb-4 border-b border-slate-100">
            ...
            <button
              type="button"
              onClick={() => setIsMobileMenuOpen(false)}
              className="p-2 rounded-xl text-slate-500 hover:text-slate-800 hover:bg-slate-100 transition-colors focus:outline-none focus:ring-2 focus:ring-sky-500"
          ...
          <div className="p-4 border-t border-slate-100 bg-white space-y-3 shrink-0">
            ...
            <div className="px-1 space-y-1.5 text-xs text-slate-600">
              <div>
                <a
                  href="tel:+966135660243"
              ...
              <div className="flex items-center space-x-3.5 pt-1">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-slate-700 hover:text-black transition-all duration-200 hover:scale-110"
                  aria-label="Twitter / X"
                >
                  <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">
                    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
