      ...
      <div className="relative w-full max-w-[1475px] mx-auto px-6 sm:px-12 lg:px-16 xl:px-24 py-20 lg:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 lg:items-end">
          <div className="lg:col-span-7">
            ...
            {/* ScrollRevealText colours its own characters, so the wrapper below
                forces every element it renders to white. If the heading still
                comes out dark, the component is setting colour via an inline
                style, which CSS classes cannot override — in that case give it a
                colour prop and pass #ffffff. */}
            <div className="mt-7 text-white [&_*]:!text-white">
              <ScrollRevealText
                text="Bring us the scope. We will tell you how it gets built."
                as="h2"
                className="text-2xl sm:text-3xl lg:text-[32px] font-extrabold tracking-tight leading-tight text-white"
              />
            </div>
