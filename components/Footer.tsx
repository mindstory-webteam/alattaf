...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-white text-slate-600 font-sans pt-12 pb-8">
      <div className="w-full max-w-[1600px] mx-auto px-4 sm:px-8 lg:px-12 xl:px-16">
        ...
        <div className="relative w-full border border-slate-300 bg-white">
            ...
            <div className="lg:col-span-4 p-8 sm:p-10 lg:p-12 space-y-6">
              ...
              <div className="flex items-center space-x-2.5 pt-1">
                <a
                  ...
                  aria-label="LinkedIn"
                  className="w-8 h-8 rounded-lg bg-slate-50 border border-slate-200 flex items-center justify-center text-slate-500 hover:text-blue-700 hover:border-blue-600 hover:bg-blue-50 transition-colors"
                >
                ...
                <a
                  ...
                  className="w-8 h-8 rounded-lg bg-slate-50 border border-slate-200 flex items-center justify-center text-slate-500 hover:text-sky-600 hover:border-sky-500 hover:bg-sky-50 transition-colors"
                >
                ...
                <a
                  ...
                  className="w-8 h-8 rounded-lg bg-slate-50 border border-slate-200 flex items-center justify-center text-slate-500 hover:text-pink-600 hover:border-pink-500 hover:bg-pink-50 transition-colors"
                >
                  <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label="Facebook"
                  className="w-8 h-8 rounded-lg bg-slate-50 border border-slate-200 flex items-center justify-center text-slate-500 hover:text-blue-600 hover:border-blue-500 hover:bg-blue-50 transition-colors"
                >
                  <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">
