            ...
            <div className="lg:col-span-4 p-8 sm:p-10 lg:p-12 space-y-6">
              ...
              <div className="flex items-center space-x-2.5 pt-1">
                ...
                <a
                  ...
                  className="w-8 h-8 rounded-lg bg-white border border-slate-200/80 shadow-xs flex items-center justify-center text-slate-900 hover:scale-105 transition-all duration-200"
                >
                ...
                <a
                  ...
                  className="w-8 h-8 rounded-lg bg-white border border-slate-200/80 shadow-xs flex items-center justify-center text-[#E4405F]  hover:scale-105 transition-all duration-200"
                >
                  <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label="Facebook"
                  className="w-8 h-8 rounded-lg bg-white border border-slate-200/80 shadow-xs flex items-center justify-center text-[#1877F2]  hover:scale-105 transition-all duration-200"
                >
                  <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">
