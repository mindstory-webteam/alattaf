...
export const metadata: Metadata = {
  ...
  description:
    "Civil, electrical, mechanical, instrumentation, fire & safety engineering, HVAC systems, plant maintenance, and security systems delivered to plant standards across Saudi Arabia.",
